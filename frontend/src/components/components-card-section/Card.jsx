    ...
    return (
        <>
            <ReactCardFlip flipDirection='vertical' isFlipped={isFlipped}>
                <div className="min-w-[240px] font-[Monda] bg-white dark:bg-[#222224] rounded-3xl shadow-lg p-4 flex flex-col items-center" onClick={flipCard}>
                ...
                <div onClick={flipCard} className='min-w-[240px] min-h-[284px] bg-white dark:bg-[#222224] rounded-3xl shadow-lg px-4 flex flex-col justify-items-center justify-center items-center'>
